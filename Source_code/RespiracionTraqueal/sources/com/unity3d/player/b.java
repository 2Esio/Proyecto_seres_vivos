...
public final class b {
    ...
    private final CameraDevice.StateCallback B = new CameraDevice.StateCallback() {
        ...
        public final void onOpened(CameraDevice cameraDevice) {
            CameraDevice unused = b.this.d = cameraDevice;
            b.e.release();
        }
    };
        ...
        public final void onImageAvailable(ImageReader imageReader) {
            if (b.e.tryAcquire()) {
                ...
                if (acquireNextImage != null) {
                    ...
                    Image unused = b.this.s = acquireNextImage;
                }
                b.e.release();
            }
        }
                    ...
                    public final void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        if (b.this.d != null) {
                            synchronized (b.this.v) {
                                CameraCaptureSession unused = b.this.u = cameraCaptureSession;
                                try {
                                    CaptureRequest.Builder unused2 = b.this.t = b.this.d.createCaptureRequest(1);
                                    if (b.this.y != null) {
