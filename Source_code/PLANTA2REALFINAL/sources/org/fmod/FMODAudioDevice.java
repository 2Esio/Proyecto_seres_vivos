...
public class FMODAudioDevice implements Runnable {
    ...
    public synchronized void stop() {
        /*
            ...
            monitor-enter(r1)
        L_0x0001:
            java.lang.Thread r0 = r1.f135a     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0011
            r0 = 0
            r1.b = r0     // Catch:{ all -> 0x001c }
            java.lang.Thread r0 = r1.f135a     // Catch:{ InterruptedException -> 0x0001 }
            r0.join()     // Catch:{ InterruptedException -> 0x0001 }
            r0 = 0
            r1.f135a = r0     // Catch:{ InterruptedException -> 0x0001 }
            goto L_0x0001
        L_0x0011:
