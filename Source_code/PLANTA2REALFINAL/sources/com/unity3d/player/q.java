...
final class q {
    ...
    public void d() {
        p pVar = this.f;
        if (pVar != null) {
            this.f128a.removeViewFromPlayer(pVar);
            this.i = false;
    ...
    public final boolean a(Context context, String str, int i2, int i3, int i4, boolean z, long j, long j2, a aVar) {
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                ...
                p unused2 = q.this.f = new p(q.this.b, str2, i5, i6, i7, z2, j3, j4, new p.a() {
        ...
        runOnUiThread((!z3 || this.g == 3) ? new Runnable() {
            ...
            public final void run() {
                if (q.this.f != null) {
                    q.this.f128a.addViewToPlayer(q.this.f, true);
