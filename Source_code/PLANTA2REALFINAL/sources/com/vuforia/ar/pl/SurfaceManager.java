...
public class SurfaceManager {
    ...
    public boolean retrieveGLSurfaceView() {
        try {
            ...
            GLSurfaceView searchForGLSurfaceView = searchForGLSurfaceView(decorView);
            this.glSurfaceView = searchForGLSurfaceView;
            if (searchForGLSurfaceView == null) {
                this.cameraSurfaceParentView = decorView;
            } else {
                this.cameraSurfaceParentView = (View) searchForGLSurfaceView.getParent();
            }
