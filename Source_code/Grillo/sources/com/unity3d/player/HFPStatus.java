...
public class HFPStatus {
    ...
    public HFPStatus(Context context) {
        this.f60a = context;
        this.e = (AudioManager) this.f60a.getSystemService("audio");
        initHFPStatusJni();
    }
    ...
    public void requestHFPStat() {
        ...
        this.c = this.f60a.registerReceiver(this.b, new IntentFilter("android.media.ACTION_SCO_AUDIO_STATE_UPDATED"));
        try {
