...
final class ReflectionHelper {
    ...
    private static a[] f65a = new a[4096];
    ...
    private static synchronized void a(a aVar, Member member) {
        synchronized (ReflectionHelper.class) {
            aVar.f67a = member;
            f65a[aVar.hashCode() & (f65a.length - 1)] = aVar;
        }
    }

    private static synchronized boolean a(a aVar) {
        synchronized (ReflectionHelper.class) {
            a aVar2 = f65a[aVar.hashCode() & (f65a.length - 1)];
            if (!aVar.equals(aVar2)) {
                return false;
            }
            aVar.f67a = aVar2.f67a;
            return true;
        }
    }
    ...
    protected static Constructor getConstructorID(Class cls, String str) {
        ...
        if (a(aVar)) {
            constructor = (Constructor) aVar.f67a;
        } else {
            Class[] a2 = a(str);
            float f = 0.0f;
