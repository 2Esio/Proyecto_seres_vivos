...
class GoogleVrProxy extends c implements GoogleVrVideo {
    ...
    public final boolean a(Activity activity, Context context, SurfaceView surfaceView, Runnable runnable) {
        ...
        if (activity == null || context == null || surfaceView == null || runnable == null) {
            ...
            if (this.g && !f()) {
                ...
                try {
                    z = ((Boolean) this.f110a.a("initialize", activity, context, surfaceView, Boolean.valueOf(this.g), this.m)).booleanValue();
                } catch (Exception e) {
    ...
    public Object getVideoSurface() {
        if (d() && !this.k.e) {
            try {
                return this.f110a.a("getVideoSurface", new Object[0]);
            } catch (Exception e) {
    ...
    public int getVideoSurfaceId() {
        if (d() && !this.k.e) {
            try {
                return ((Integer) this.f110a.a("getVideoSurfaceId", new Object[0])).intValue();
            } catch (Exception e) {
    ...
    public long loadGoogleVr(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        if (!runOnUiThreadWithSync(new Runnable() {
            public final void run() {
                try {
                    atomicLong2.set(((Long) GoogleVrProxy.this.f110a.a("load", Boolean.valueOf(z6), Boolean.valueOf(z7), Boolean.valueOf(z8), Boolean.valueOf(z9), Boolean.valueOf(z10), GoogleVrProxy.this.h)).longValue());
    ...
    public void pauseGvrLayout() {
        if (this.k.a() && !this.k.e) {
            ...
            if (this.f110a != null) {
                this.f110a.a("pause", new Object[0]);
            }
            this.k.e = true;
        }
    }
    ...
    public void resumeGvrLayout() {
        if (this.k.a() && this.k.e) {
            if (this.f110a != null) {
                this.f110a.a("resume", new Object[0]);
            }
            this.k.e = false;
        }
    }
                        ...
                        try {
                            if (z) {
                                if (!GoogleVrProxy.this.d()) {
                                    if (GoogleVrProxy.this.f110a == null || GoogleVrProxy.this.b == null || GoogleVrProxy.this.b.addViewToPlayer((View) GoogleVrProxy.this.f110a.a("getGvrLayout", new Object[0]), true)) {
                                        if (GoogleVrProxy.this.f110a != null) {
                                            GoogleVrProxy.this.f110a.a("enable", true);
                                        }
                            ...
                            if (!z && GoogleVrProxy.this.d()) {
                                ...
                                if (GoogleVrProxy.this.f110a != null) {
                                    GoogleVrProxy.this.f110a.a("enable", false);
                                }
                                if (GoogleVrProxy.this.f110a != null && GoogleVrProxy.this.b != null) {
                                    GoogleVrProxy.this.b.removeViewFromPlayer((View) GoogleVrProxy.this.f110a.a("getGvrLayout", new Object[0]));
                                }
                            }
                        } catch (Exception e) {
                            GoogleVrProxy googleVrProxy = GoogleVrProxy.this;
    ...
    public void unloadGoogleVr() {
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                try {
                    if (GoogleVrProxy.this.f110a != null) {
                        GoogleVrProxy.this.f110a.a("unload", new Object[0]);
                        GoogleVrProxy.this.f110a.a("deinitialize", new Object[0]);
                        GoogleVrProxy.this.f110a = null;
                    }
