...
public class ImageMetadata {
    ...
    public byte getByte(int i) {
        ...
        if (this.sketchEntry.b == 0 && this.sketchEntry.c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public int getInt(int i) {
        ...
        if (this.sketchEntry.b == 1 && this.sketchEntry.c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public float getFloat(int i) {
        ...
        if (this.sketchEntry.b == 2 && this.sketchEntry.c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public long getLong(int i) {
        ...
        if (this.sketchEntry.b == 3 && this.sketchEntry.c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.b), Integer.valueOf(this.sketchEntry.c)}));
    }

    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.b == 4 && this.sketchEntry.c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public Rational getRational(int i) {
        ...
        if (this.sketchEntry.b == 5 && this.sketchEntry.c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public byte[] getByteArray(int i) {
        ...
        if (this.sketchEntry.b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public int[] getIntArray(int i) {
        ...
        if (this.sketchEntry.b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public float[] getFloatArray(int i) {
        ...
        if (this.sketchEntry.b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public long[] getLongArray(int i) {
        ...
        if (this.sketchEntry.b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        if (this.sketchEntry.b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        if (this.sketchEntry.b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f9a);
    ...
    private void getMetdataEntry(int i, a aVar) {
        aVar.f9a = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        if (aVar.f9a != 0) {
            aVar.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, aVar.f9a);
            aVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, aVar.f9a);
            return;
        }
