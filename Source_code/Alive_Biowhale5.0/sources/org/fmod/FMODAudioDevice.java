...
public class FMODAudioDevice implements Runnable {
    ...
    private volatile Thread f131a = null;
    ...
    public boolean isRunning() {
        return this.f131a != null && this.f131a.isAlive();
    }
    ...
    public synchronized void start() {
        ...
        this.f131a = new Thread(this, "FMODAudioDevice");
        this.f131a.setPriority(10);
        this.b = true;
        this.f131a.start();
        if (this.g != null) {
            this.g.b();
    ...
    public synchronized void stop() {
        /*
            ...
            monitor-enter(r1)
        L_0x0001:
            java.lang.Thread r0 = r1.f131a     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0011
            r0 = 0
            r1.b = r0     // Catch:{ all -> 0x001c }
            java.lang.Thread r0 = r1.f131a     // Catch:{ InterruptedException -> 0x0001 }
            r0.join()     // Catch:{ InterruptedException -> 0x0001 }
            r0 = 0
            r1.f131a = r0     // Catch:{ InterruptedException -> 0x0001 }
            goto L_0x0001
        L_0x0011:
