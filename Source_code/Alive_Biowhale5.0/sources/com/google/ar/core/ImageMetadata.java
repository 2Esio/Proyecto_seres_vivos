...
public class ImageMetadata {
    ...
    public byte getByte(int i) {
        ...
        if (oVar.b == 0 && oVar.c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public byte[] getByteArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.b == 4 && oVar.c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.b == 2 && oVar.c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public float[] getFloatArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public int getInt(int i) {
        ...
        if (oVar.b == 1 && oVar.c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public int[] getIntArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.b == 3 && oVar.c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public long[] getLongArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    private void getMetdataEntry(int i, o oVar) {
        ...
        oVar.f32a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            oVar.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            oVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, oVar.f32a);
            return;
        }
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.b == 5 && oVar.c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        o oVar = this.sketchEntry;
        if (oVar.b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f32a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f32a);
