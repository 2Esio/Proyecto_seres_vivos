...
public class Camera1_Preview implements Camera.PreviewCallback {
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:163:0x027c, code lost:
        r2 = true;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:182:0x02c3, code lost:
        if (r2 == false) goto L_0x02dc;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:184:0x02c8, code lost:
        if (r1 == AR_CAMERA_PARAMTYPE_FOCUSMODE) goto L_0x02cb;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:186:?, code lost:
        r4.isAutoFocusing = true;
        r4.camera.autoFocus(new com.vuforia.ar.pl.Camera1_Preview.AnonymousClass1(r0));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:187:0x02d8, code lost:
        com.vuforia.ar.pl.SystemTools.setSystemErrorCode(6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:189:0x02db, code lost:
        return false;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:190:0x02dc, code lost:
        return true;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:191:0x02dd, code lost:
        com.vuforia.ar.pl.SystemTools.setSystemErrorCode(6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:193:0x02e0, code lost:
        return false;
     */
    ...
    public boolean setTypedCameraParameter(int r19, int r20, java.lang.Object r21) {
        ...
        L_0x0023:
            ...
            r13 = 1
            switch(r1) {
                case 536870913: goto L_0x0291;
                case 536870914: goto L_0x023b;
                case 536870916: goto L_0x0237;
                case 536870920: goto L_0x0233;
        ...
        L_0x002e:
            r2 = r21
            java.lang.Boolean r2 = (java.lang.Boolean) r2     // Catch:{ Exception -> 0x02e1 }
            boolean r2 = r2.booleanValue()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x003d
            r7.setVideoStabilization(r13)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x003d:
            r7.setVideoStabilization(r6)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0042:
            r2 = r21
            java.lang.Number r2 = (java.lang.Number) r2     // Catch:{ Exception -> 0x02e1 }
            int r2 = r2.intValue()     // Catch:{ Exception -> 0x02e1 }
            boolean r3 = com.vuforia.ar.pl.SystemTools.checkMinimumApiLevel(r10)     // Catch:{ Exception -> 0x02e1 }
        ...
        L_0x0054:
            r2 = 0
        L_0x0055:
            r7.setRecordingHint(r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x005a:
        ...
        L_0x0063:
            r7.set(r3, r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0068:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)     // Catch:{ Exception -> 0x02e1 }
            return r6
        L_0x006c:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)     // Catch:{ Exception -> 0x02e1 }
            return r6
        ...
        L_0x007c:
            ...
            return r6
        L_0x0080:
            boolean r2 = com.vuforia.ar.pl.SystemTools.checkMinimumApiLevel(r9)     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x0099
            boolean r2 = r7.isZoomSupported()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x0099
            r2 = r21
            java.lang.Number r2 = (java.lang.Number) r2     // Catch:{ Exception -> 0x02e1 }
            int r2 = r2.intValue()     // Catch:{ Exception -> 0x02e1 }
            r7.setZoom(r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0099:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)     // Catch:{ Exception -> 0x02e1 }
            return r6
        ...
        L_0x00a5:
            ...
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r12)     // Catch:{ Exception -> 0x02e1 }
            ...
            r1.append(r3)     // Catch:{ Exception -> 0x02e1 }
            r1.append(r2)     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r2 = ")"
            r1.append(r2)     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r1 = r1.toString()     // Catch:{ Exception -> 0x02e1 }
            com.vuforia.ar.pl.SystemTools.logSystemError(r1)     // Catch:{ Exception -> 0x02e1 }
            return r6
        L_0x00d2:
            boolean r2 = r7.isAutoWhiteBalanceLockSupported()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x02bd
            r7.setAutoWhiteBalanceLock(r6)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x00dd:
            boolean r2 = r7.isAutoWhiteBalanceLockSupported()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x02bd
            r7.setAutoWhiteBalanceLock(r13)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x00e8:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)     // Catch:{ Exception -> 0x02e1 }
            return r6
        L_0x00ec:
            ...
            r2 = r21
            java.lang.Number r2 = (java.lang.Number) r2     // Catch:{ Exception -> 0x02e1 }
            float r2 = r2.floatValue()     // Catch:{ Exception -> 0x02e1 }
            float r3 = r7.getExposureCompensationStep()     // Catch:{ Exception -> 0x02e1 }
        ...
        L_0x0106:
            float r2 = r2 / r3
            int r2 = java.lang.Math.round(r2)     // Catch:{ Exception -> 0x02e1 }
            r7.setExposureCompensation(r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0110:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)     // Catch:{ Exception -> 0x02e1 }
            return r6
        L_0x0114:
            ...
            java.lang.Number r2 = (java.lang.Number) r2     // Catch:{ Exception -> 0x02e1 }
            int r2 = r2.intValue()     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r2 = java.lang.Integer.toString(r2)     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r3 = "iso-values"
            java.lang.String r3 = r7.get(r3)     // Catch:{ Exception -> 0x02e1 }
            if (r3 == 0) goto L_0x0148
            java.lang.String r5 = ","
            java.lang.String[] r3 = r3.split(r5)     // Catch:{ Exception -> 0x02e1 }
            r5 = 0
        L_0x012f:
            int r9 = r3.length     // Catch:{ Exception -> 0x02e1 }
            if (r5 >= r9) goto L_0x0148
            r9 = r3[r5]     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r9 = r9.toLowerCase()     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r10 = r2.toLowerCase()     // Catch:{ Exception -> 0x02e1 }
            boolean r9 = r9.contains(r10)     // Catch:{ Exception -> 0x02e1 }
            if (r9 == 0) goto L_0x0145
            r2 = r3[r5]     // Catch:{ Exception -> 0x02e1 }
            goto L_0x0148
        L_0x0145:
            int r5 = r5 + 1
            goto L_0x012f
        ...
        L_0x014f:
            ...
            return r6
        L_0x0165:
            boolean r2 = r7.isAutoExposureLockSupported()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x02bd
            r7.setAutoExposureLock(r6)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0170:
            boolean r2 = r7.isAutoExposureLockSupported()     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x02bd
            r7.setAutoExposureLock(r13)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x017b:
            boolean r2 = com.vuforia.ar.pl.SystemTools.checkMinimumApiLevel(r10)     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x022f
            r2 = r21
            float[] r2 = (float[]) r2     // Catch:{ Exception -> 0x02e1 }
            float[] r2 = (float[]) r2     // Catch:{ Exception -> 0x02e1 }
            int r3 = r2.length     // Catch:{ Exception -> 0x02e1 }
            r9 = 5
            r10 = 2
            if (r3 == r9) goto L_0x0190
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r10)     // Catch:{ Exception -> 0x02e1 }
            return r6
        L_0x0190:
            r3 = r2[r6]     // Catch:{ Exception -> 0x02e1 }
            ...
            if (r3 > 0) goto L_0x022b
            r3 = r2[r13]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r11 ? 1 : (r3 == r11 ? 0 : -1))
            if (r3 < 0) goto L_0x022b
            r3 = r2[r13]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r9 ? 1 : (r3 == r9 ? 0 : -1))
            if (r3 > 0) goto L_0x022b
            r3 = r2[r10]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r11 ? 1 : (r3 == r11 ? 0 : -1))
            if (r3 < 0) goto L_0x022b
            r3 = r2[r10]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r9 ? 1 : (r3 == r9 ? 0 : -1))
            if (r3 > 0) goto L_0x022b
            r3 = r2[r12]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r11 ? 1 : (r3 == r11 ? 0 : -1))
            if (r3 < 0) goto L_0x022b
            r3 = r2[r12]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r9 ? 1 : (r3 == r9 ? 0 : -1))
            if (r3 > 0) goto L_0x022b
            r3 = r2[r5]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r11 ? 1 : (r3 == r11 ? 0 : -1))
            if (r3 < 0) goto L_0x022b
            r3 = r2[r5]     // Catch:{ Exception -> 0x02e1 }
            int r3 = (r3 > r9 ? 1 : (r3 == r9 ? 0 : -1))
            ...
            goto L_0x022b
        L_0x01cf:
            android.graphics.Rect r3 = new android.graphics.Rect     // Catch:{ Exception -> 0x02e1 }
            r9 = r2[r6]     // Catch:{ Exception -> 0x02e1 }
            ...
            int r9 = (int) r14
            int r9 = r9 + -1000
            r11 = r2[r13]     // Catch:{ Exception -> 0x02e1 }
            double r14 = (double) r11
            java.lang.Double.isNaN(r14)
            double r14 = r14 * r16
            int r11 = (int) r14
            int r11 = r11 + -1000
            r10 = r2[r10]     // Catch:{ Exception -> 0x02e1 }
            double r14 = (double) r10
            java.lang.Double.isNaN(r14)
            double r14 = r14 * r16
            int r10 = (int) r14
            int r10 = r10 + -1000
            r12 = r2[r12]     // Catch:{ Exception -> 0x02e1 }
            double r14 = (double) r12
            java.lang.Double.isNaN(r14)
            double r14 = r14 * r16
            int r12 = (int) r14
            int r12 = r12 + -1000
            r3.<init>(r9, r11, r10, r12)     // Catch:{ Exception -> 0x02e1 }
            java.util.ArrayList r9 = new java.util.ArrayList     // Catch:{ Exception -> 0x02e1 }
            r9.<init>()     // Catch:{ Exception -> 0x02e1 }
            android.hardware.Camera$Area r10 = new android.hardware.Camera$Area     // Catch:{ Exception -> 0x02e1 }
            r2 = r2[r5]     // Catch:{ Exception -> 0x02e1 }
            double r11 = (double) r2
            r14 = 4652007308841189376(0x408f400000000000, double:1000.0)
            java.lang.Double.isNaN(r11)
            double r11 = r11 * r14
            int r2 = (int) r11
            r10.<init>(r3, r2)     // Catch:{ Exception -> 0x02e1 }
            r9.add(r10)     // Catch:{ Exception -> 0x02e1 }
            int r2 = r7.getMaxNumFocusAreas()     // Catch:{ Exception -> 0x02e1 }
            if (r2 <= 0) goto L_0x02bd
            r7.setFocusAreas(r9)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x022b:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r10)     // Catch:{ Exception -> 0x02e1 }
            return r6
        ...
        L_0x0237:
            ...
            return r6
        L_0x023b:
            android.hardware.Camera r3 = r4.camera     // Catch:{ Exception -> 0x02e1 }
            r3.cancelAutoFocus()     // Catch:{ Exception -> 0x02e1 }
            r3 = r21
            java.lang.Number r3 = (java.lang.Number) r3     // Catch:{ Exception -> 0x02e1 }
            int r3 = r3.intValue()     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r5 = "auto"
            switch(r3) {
                case 805306384: goto L_0x027e;
                case 805306400: goto L_0x0279;
                case 805306432: goto L_0x0263;
                case 805306496: goto L_0x025d;
                case 805306624: goto L_0x0257;
                case 805306880: goto L_0x0251;
        ...
        L_0x0251:
            ...
            r7.setFocusMode(r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x0257:
        ...
        L_0x025d:
            ...
            goto L_0x02bd
        L_0x0263:
            java.util.List r2 = r7.getSupportedFocusModes()     // Catch:{ Exception -> 0x02e1 }
            java.lang.String r3 = "continuous-video"
            boolean r2 = r2.contains(r3)     // Catch:{ Exception -> 0x02e1 }
        ...
        L_0x0275:
            ...
            return r6
        L_0x0279:
            r7.setFocusMode(r5)     // Catch:{ Exception -> 0x02e1 }
        L_0x027c:
            r2 = 1
            goto L_0x02be
        L_0x027e:
            java.util.List r3 = r7.getSupportedFocusModes()     // Catch:{ Exception -> 0x02e1 }
            boolean r3 = r3.contains(r2)     // Catch:{ Exception -> 0x02e1 }
        ...
        L_0x0291:
            ...
            int r2 = r2.intValue()     // Catch:{ Exception -> 0x02e1 }
            switch(r2) {
                case 805306369: goto L_0x02b8;
                case 805306370: goto L_0x02a4;
                case 805306371: goto L_0x029c;
                case 805306372: goto L_0x02a0;
                default: goto L_0x029c;
            }     // Catch:{ Exception -> 0x02e1 }
        L_0x029c:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r12)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02e0
        L_0x02a0:
            ...
            return r6
        L_0x02a4:
            java.util.List r2 = r7.getSupportedFlashModes()     // Catch:{ Exception -> 0x02e1 }
            boolean r2 = r2.contains(r3)     // Catch:{ Exception -> 0x02e1 }
            if (r2 == 0) goto L_0x02b2
            r7.setFlashMode(r3)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x02b2:
            java.lang.String r2 = "on"
            r7.setFlashMode(r2)     // Catch:{ Exception -> 0x02e1 }
            goto L_0x02bd
        L_0x02b8:
        ...
        L_0x02bd:
            r2 = 0
        L_0x02be:
            android.hardware.Camera r3 = r4.camera     // Catch:{ Exception -> 0x02dd }
            r3.setParameters(r7)     // Catch:{ Exception -> 0x02dd }
            if (r2 == 0) goto L_0x02dc
            r2 = 536870914(0x20000002, float:1.0842024E-19)
            if (r1 == r2) goto L_0x02cb
            goto L_0x02dc
        L_0x02cb:
            r4.isAutoFocusing = r13     // Catch:{ Exception -> 0x02d8 }
            android.hardware.Camera r1 = r4.camera     // Catch:{ Exception -> 0x02d8 }
            com.vuforia.ar.pl.Camera1_Preview$1 r2 = new com.vuforia.ar.pl.Camera1_Preview$1     // Catch:{ Exception -> 0x02d8 }
            r2.<init>()     // Catch:{ Exception -> 0x02d8 }
            r1.autoFocus(r2)     // Catch:{ Exception -> 0x02d8 }
            goto L_0x02dc
        L_0x02d8:
            com.vuforia.ar.pl.SystemTools.setSystemErrorCode(r8)
            return r6
