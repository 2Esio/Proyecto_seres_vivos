...
public class UnityPlayer extends FrameLayout implements IUnityPlayerLifecycleEvents, f {
    ...
    private class e extends Thread {
        ...
        public final void a(Runnable runnable) {
            if (this.f95a != null) {
                a(d.PAUSE);
                Message.obtain(this.f95a, runnable).sendToTarget();
            }
        }
        ...
        public final void run() {
            setName("UnityMain");
            Looper.prepare();
            this.f95a = new Handler(new Handler.Callback() {
                private void a() {
                ...
                public final boolean handleMessage(Message message) {
                    ...
                    if (e.this.b && e.this.e <= 0) {
                        Message.obtain(e.this.f95a, UnityPlayer.RUN_STATE_CHANGED_MSG_CODE, d.NEXT_FRAME).sendToTarget();
                        e.this.e++;
                    }
                    return true;
                }
