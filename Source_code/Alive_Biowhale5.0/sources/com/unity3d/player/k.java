...
public final class k extends Dialog implements TextWatcher, View.OnClickListener {
    ...
    public final String a() {
        InputMethodSubtype currentInputMethodSubtype = ((InputMethodManager) this.f110a.getSystemService("input_method")).getCurrentInputMethodSubtype();
    ...
    public final View createSoftInputView() {
        RelativeLayout relativeLayout = new RelativeLayout(this.f110a);
        relativeLayout.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        relativeLayout.setBackgroundColor(d);
        AnonymousClass3 r1 = new EditText(this.f110a) {
            ...
            public final void onWindowFocusChanged(boolean z) {
                ...
                if (z) {
                    ((InputMethodManager) k.this.f110a.getSystemService("input_method")).showSoftInput(this, 0);
                }
            }
        };
        ...
        Button button = new Button(this.f110a);
        button.setText(this.f110a.getResources().getIdentifier("ok", "string", "android"));
