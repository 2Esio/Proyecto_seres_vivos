...
final class q {
    ...
    public void d() {
        p pVar = this.f;
        if (pVar != null) {
            this.f124a.removeViewFromPlayer(pVar);
            this.i = false;
    ...
    public final boolean a(Context context, String str, int i2, int i3, int i4, boolean z, long j, long j2, a aVar) {
        ...
        runOnUiThread((!z3 || this.g == 3) ? new Runnable() {
            ...
            public final void run() {
                if (q.this.f != null) {
                    q.this.f124a.addViewToPlayer(q.this.f, true);
