...
public class HFPStatus {
    ...
    public HFPStatus(Context context) {
        this.f56a = context;
        this.e = (AudioManager) this.f56a.getSystemService("audio");
        initHFPStatusJni();
    }
    ...
    public void requestHFPStat() {
        ...
        this.c = this.f56a.registerReceiver(this.b, new IntentFilter("android.media.ACTION_SCO_AUDIO_STATE_UPDATED"));
        try {
