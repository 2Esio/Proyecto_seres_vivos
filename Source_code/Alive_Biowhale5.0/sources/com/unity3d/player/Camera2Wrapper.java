...
public class Camera2Wrapper implements d {
    ...
    public boolean initializeCamera2(int i, int i2, int i3, int i4, int i5) {
        if (!j.f109a || this.b != null || UnityPlayer.currentActivity == null) {
            return false;
        }
        this.b = new b(this);
        return this.b.a(this.f49a, i, i2, i3, i4, i5);
    }

    /* access modifiers changed from: protected */
    public boolean isCamera2AutoFocusPointSupported(int i) {
        if (j.f109a) {
            return b.c(this.f49a, i);
        }
        return false;
    }
